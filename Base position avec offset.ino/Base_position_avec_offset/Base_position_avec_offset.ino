...
const float toolLength = 50.0;   // mm, horizontal, toujours parallèle au sol
const float toolHeight = -10.0;  // mm, outil 10 mm plus bas que le poignet
...
float maxStepLeft = 1.2; 
float maxStepRight = 1.2;
float maxStepZ = 1.5;
...
float currentCmdLeft = 0.0;
float currentCmdRight = 0.0;
